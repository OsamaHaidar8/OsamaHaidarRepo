                               ...
                               if(isset($_POST["submit"]))
                                 {
                                    ...
                                    {
                                       $query="insert into books (CourseName, Description, Level_id, Links,sub_id,image) value (?,?,?,?,?,?)";
                                        ...
                                        <form role="form" method="post" enctype="multipart/form-data">
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label>Photo</label>
                                                <input type="file" name="file" placeholder="Please Enter books's Photo"
                                                class="form-control">
                            ...
                            <div class="panel panel-default">
                                ...
                                if(isset($_GET['action'],$_GET['id']))
                                {
                                 ...
                                 switch($action)
                                 {
                                    ...
                                    case "delete":
                                       $query="delete from books  where id=:catid";
                                       $stm= $con->prepare($query);
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover"
                                            ...
                                            <tbody>
                                           <?php
                                           $query="select subjects.name as subject,level.name as level, books.id,books.image,books.CourseName,books.Description
                                           ,books.Links from books join subjects on books.sub_id=subjects.id join level on books.level_id=level.id";
                                                   $stm= $con->prepare($query);
                                                   $stm->execute();
                                                   if($stm->rowCount())
                                                   {
                                             ...
                                             ?>
                                                <tr class="odd gradeX">
                                                   ...
                                                   <td><?php echo $id ?></td>
                                                    ...
                                                    <td>
                                                      <a href="bookEdit.php?action=edit&id=<?php echo $id ?>" class='btn btn-success' >Edit</a>
