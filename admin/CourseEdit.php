...
?>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><i class="fa fa-users"></i> Edit Course</h2>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fa fa-plus-circle"></i> Edit Course
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                 <?php
                                                ...
                                                {
                                                $id=$_GET['id'];                                  
                                                   $stm= $con->prepare("select * from courses where id=:catid");
                                                   ...
                                                   if($stm->rowCount())
                                                   {
                                                    ...
                                                    if(isset($_FILES['file'])){
                                                        ...
                                                        //updating with image
                                                        $query="Update courses set CourseName=? , Description=? , Level_id=? , Links=?,image=?,sub_id=? where id=?";
                                                             $stm= $con->prepare($query);
                                                             $stm->execute(array($name,$description,$level,$link,$file_name,$sub_id,$id)); 
                                                        ...
                                                        if($stm -> rowCount()){
                                                         ...
                                                         {
                                                            $query="Update courses set CourseName=? , Description=? , Level_id=? , Links=?,sub_id=? where id=?";
                                                             $stm= $con->prepare($query);
                                                             $stm->execute(array($name,$description,$level,$link,$sub_id,$id));     
                                                             if ($stm->rowCount())
                                                             {
                                                               echo "<script>
